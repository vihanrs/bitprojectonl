...
// create funtion for fill data into table 
const fillDataIntoTable2=(tableID,dataList,displayProperty,editButtonFunction,deleteButtonFunction,printButtonFunction,buttonVisibility = true)=>{
    //create variable for store table body
    const tableBody = tableID.children[1];
     tableBody.innerHTML = '';
     dataList.forEach((item,ind) => {
...
// create funtion for fill data into table 
const fillDataIntoTable3=(tableID,dataList,displayProperty,editButtonFunction,deleteButtonFunction,printButtonFunction,buttonVisibility = true)=>{
    //create variable for store table body
    const tableBody = tableID.children[1];
     tableBody.innerHTML = '';
     dataList.forEach((item,ind) => {
...
// create funtion for fill data into table 
const fillDataIntoTable4=(tableID,dataList,displayProperty,buttonVisibility = true)=>{
    //create variable for store table body
    const tableBody = tableID.children[1];
     tableBody.innerHTML = '';
     dataList.forEach((item,ind) => {
...
// create funtion for fill data into table 
const fillDataIntoTable5=(tableID,dataList,displayProperty,editFunction,buttonVisibility = true)=>{
    //create variable for store table body
    const tableBody = tableID.children[1];
     tableBody.innerHTML = '';
     dataList.forEach((item,ind) => {
